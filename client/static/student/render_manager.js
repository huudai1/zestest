    ...
    async initView(isDetail = false) {
        ...
        if (webpData && webpData.length > 0) {
            ...
            webpData.forEach((imgData) => {
                ...
                a.href = imgUrl;
                // Kích thước giả định để PhotoSwipe tính toán, sẽ được cập nhật khi mở
                ...
                // TỐI ƯU MOBILE: Lazy loading & Async decoding
            ...
            container.innerHTML = `<div class="error-msg">${typeof I18n !== 'undefined' ? I18n.t('stu_img_error') : 'No exam image data.'}</div>`;
        }

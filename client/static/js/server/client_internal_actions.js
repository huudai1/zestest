...
const ClientInternal = {
    ...
    // --- SỬA TẠI ĐÂY: CHỐNG RÁC CƯỜNG ĐỘ CAO ---
        const garbage = ["undefined", "null", "new_user", ""];
        if (!id || garbage.includes(String(id).toLowerCase().trim())) {
            return ""; // Trả về rỗng để Uploader biết mà đợi
        }
        return id;
    },

...
window.distributeMasterToRows = function(rawText, from, to, type) {
    ...
    // UniversalNormalizer.parse đã tự normalize số câu về index 0-based
    // (VD: "101A 102B..." → parsedData[0]='A', parsedData[1]='B'...)
    // Nên chỉ cần map theo INDEX: parsedData[index] → input ans_(from + index)
    // from=101 → input ans_101, ans_102... (đúng với tên input trong UI editor)
